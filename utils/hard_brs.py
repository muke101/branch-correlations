...
import pickle
import polars as pl
from utils.get_traces import branchnet_benchmarks
...
if __name__ == "__main__":
    ...
    for benchmark in branchnet_benchmarks:
        ...
        with open(hard_branches_dir+benchmark+"_top"+str(NUM_BRS_TO_PRINT), 'w') as f:
            for br in brs:
                f.write('{}\n'.format(hex(br)))
