...
adjusted_simpts = [(s, indxs[s]) for s in simpts[last_simpt+1:]]

adjusted_simpt_file = open(sys.argv[1]+".adjusted_no_offset", "w")
adjusted_weight_file = open(sys.argv[2]+".adjusted_no_offset", "w")
